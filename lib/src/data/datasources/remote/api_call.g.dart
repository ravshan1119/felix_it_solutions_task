...
class _ApiCall implements ApiCall {
  ...
  Future<RegisterResponseModel> getRegister(
      RegisterBodyModel registerBody) async {
  ...
  @override
  Future<LoginResponseModel> getLogin(LoginBodyModel loginBody) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AdsSaveResponseModel> getSave(AdsBodyModel adsBody) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(adsBody.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AdsSaveResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AdsSaveResponseModel.fromJson(_result.data!);
    return value;
  }
